...
.about .lead{margin:0 0 26px;font-size:18px;line-height:1.72;color:var(--ink2);max-width:74ch}
.cols{display:grid;grid-template-columns:repeat(3,1fr);gap:26px}
.cols div{border-left:2px solid var(--line);padding-left:18px}
.cols b{display:block;font-size:16px;font-weight:700;letter-spacing:-.01em;margin-bottom:7px}
.cols span{font-size:14.5px;line-height:1.68;color:var(--ink2)}
...
<section class="sec about"><div class="wrap">
  <div class="lab"><h2 data-fr="Le principe" data-en="The principle">Le principe</h2><span class="rule"></span><span class="n" data-fr="ce qui vaut pour tous les modules" data-en="what holds for every module">ce qui vaut pour tous les modules</span></div>
  <p class="lead" data-fr="Tactile reprend le monde de Minecraft couche par couche et le refait en profondeur. Chaque module en traite une, s'installe seul, et se combine aux autres." data-en="Tactile takes the world of Minecraft layer by layer and rebuilds it in depth. Each module handles one, installs on its own, and combines with the others.">Tactile reprend le monde de Minecraft couche par couche et le refait en profondeur. Chaque module en traite une, s'installe seul, et se combine aux autres.</p>
  <div class="cols">
    <div><b data-fr="Lire le monde pour l'améliorer" data-en="Reading the world to enrich it">Lire le monde pour l'améliorer</b>
      <span data-fr="Chaque module part de ce que le jeu a déjà produit et l'enrichit. Le monde reste le sien : son équilibre, ses proportions, ses habitudes. Une partie en cours se reprend telle quelle, et le retour en arrière est toujours possible." data-en="Every module starts from what the game has already produced and enriches it. The world stays its own: its balance, its proportions, its habits. An ongoing save carries on as it is, and stepping back is always possible.">Chaque module part de ce que le jeu a déjà produit et l'enrichit. Le monde reste le sien : son équilibre, ses proportions, ses habitudes. Une partie en cours se reprend telle quelle, et le retour en arrière est toujours possible.</span></div>
    <div><b data-fr="Tout en procédural pour donner vie au monde" data-en="All procedural, to bring the world alive">Tout en procédural pour donner vie au monde</b>
      <span data-fr="Les formes naissent de règles plutôt que d'un modèle recopié. Rien ne se répète, chaque élément est unique, et ce que les autres mods apportent trouve sa place sans qu'aucune liste ait été écrite." data-en="Shapes are born from rules rather than from a copied model. Nothing repeats, every element is unique, and whatever other mods bring finds its place without a single list being written.">Les formes naissent de règles plutôt que d'un modèle recopié. Rien ne se répète, chaque élément est unique, et ce que les autres mods apportent trouve sa place sans qu'aucune liste ait été écrite.</span></div>
    <div><b data-fr="Des interactions repensées pour être immersives et logiques" data-en="Interactions rethought to be immersive and logical">Des interactions repensées pour être immersives et logiques</b>
      <span data-fr="Ce qui se réglait derrière une interface se manipule dans le monde, à la main et à vue. Le geste devient la dernière couche, celle qui donne son nom à la suite." data-en="What used to be set behind an interface is handled in the world, by hand and in plain sight. The gesture becomes the last layer, the one the suite is named after.">Ce qui se réglait derrière une interface se manipule dans le monde, à la main et à vue. Le geste devient la dernière couche, celle qui donne son nom à la suite.</span></div>
  </div>
</div></section>
