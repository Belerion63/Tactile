...
<section class="sec about"><div class="wrap">
  ...
  <p class="lead" data-fr="Tactile n'ajoute pas de contenu au monde : il en reprend les couches une à une et les refait en profondeur. Chaque module en traite une, s'installe seul, et se combine aux autres." data-en="Tactile does not add content to the world: it takes its layers one by one and rebuilds them in depth. Each module handles one, installs on its own, and combines with the others.">Tactile n'ajoute pas de contenu au monde : il en reprend les couches une à une et les refait en profondeur. Chaque module en traite une, s'installe seul, et se combine aux autres.</p>
  <div class="cols">
    <div><b data-fr="Reprendre, pas ajouter" data-en="Reusing, not adding">Reprendre, pas ajouter</b>
      <span data-fr="Un module relit ce que le jeu a déjà produit et le réinterprète. Rien n'est inventé ni substitué : l'équilibre du jeu reste le sien, une partie en cours est reprise telle quelle, et le retour en arrière est toujours possible." data-en="A module re-reads what the game has already produced and reinterprets it. Nothing is invented or substituted: the game's balance stays its own, an ongoing save is taken as it is, and stepping back is always possible.">Un module relit ce que le jeu a déjà produit et le réinterprète. Rien n'est inventé ni substitué : l'équilibre du jeu reste le sien, une partie en cours est reprise telle quelle, et le retour en arrière est toujours possible.</span></div>
    <div><b data-fr="Procédural, jamais dessiné" data-en="Procedural, never drawn by hand">Procédural, jamais dessiné</b>
      <span data-fr="Les formes se déduisent de règles au lieu d'être modelées une par une. Rien ne se répète, et ce que les autres mods apportent est pris en charge sans qu'aucune liste ait été écrite." data-en="Shapes are derived from rules instead of being modelled one by one. Nothing repeats, and whatever other mods bring is handled without a single list being written.">Les formes se déduisent de règles au lieu d'être modelées une par une. Rien ne se répète, et ce que les autres mods apportent est pris en charge sans qu'aucune liste ait été écrite.</span></div>
    <div><b data-fr="Le geste, pas le menu" data-en="The gesture, not the menu">Le geste, pas le menu</b>
      <span data-fr="Ce qui se réglait derrière une interface se manipule dans le monde. C'est la dernière couche, celle qui donne son nom à la suite." data-en="What used to be set behind an interface is handled in the world. It is the last layer, the one the suite is named after.">Ce qui se réglait derrière une interface se manipule dans le monde. C'est la dernière couche, celle qui donne son nom à la suite.</span></div>
  </div>
</div></section>
